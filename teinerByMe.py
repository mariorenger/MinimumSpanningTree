...
#install module: pip install graphviz, install exe graphviz == 2.28 
import graphviz #thu vien render do thi
import os
os.environ["PATH"] += os.pathsep + 'C:/Program Files (x86)/Graphviz2.38/bin'

#
# render do thi ra file pdf
#
def render_graph(g):
    dot = graphviz.Graph()
...
# tinh toan
#    
def algorithm_u(ns, m):# chia ns thanh m tap con
...
if __name__ == '__main__':
    g = create_random_graph(12, 0.25)
    terminals = random_terminals(g)
    tree_edges = get_steiner_tree(g, terminals)
    render_steiner(g, terminals, tree_edges)